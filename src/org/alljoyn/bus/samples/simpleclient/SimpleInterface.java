...
public interface SimpleInterface {
    ...
    //String Ping(int inStr) throws BusException;
    String Ping(double[] inStr, String ID) throws BusException;
    @BusMethod
    double[] giveData(double[] inputArray) throws BusException;
    @BusMethod
    int giveImageData() throws BusException;//returns how many times giveActualImageData needs to be called by client
    @BusMethod
    int[] giveActualImageData(int clientid, int datachunk) throws BusException;
    @BusMethod
    void takeImageData(int[] array,int clientid, int datachunk) throws BusException;
    @BusMethod
    int getSizeOfEachChunk() throws BusException;
    @BusMethod
    int getClientID() throws BusException;
    @BusMethod
    double getFrequencyToRunAt() throws BusException;
}
